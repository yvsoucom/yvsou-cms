...
final class UpdateyvsouRequestTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(UpdateyvsouRequest::class, $this->subject);
    }
    ...
    {
        $class = new ReflectionClass(UpdateyvsouRequest::class);
