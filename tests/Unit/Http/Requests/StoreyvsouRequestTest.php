...
final class StoreyvsouRequestTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(StoreyvsouRequest::class, $this->subject);
    }
    ...
    {
        $class = new ReflectionClass(StoreyvsouRequest::class);
