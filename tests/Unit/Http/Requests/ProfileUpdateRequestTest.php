...
final class ProfileUpdateRequestTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(ProfileUpdateRequest::class, $this->subject);
    }
    ...
    {
        $class = new ReflectionClass(ProfileUpdateRequest::class);
