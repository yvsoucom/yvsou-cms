...
final class PreventReinstallTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(PreventReinstall::class, $this->subject);
    }
    ...
    {
        $class = new ReflectionClass(PreventReinstall::class);
