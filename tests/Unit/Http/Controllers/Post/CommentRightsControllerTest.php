...
final class CommentRightsControllerTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(CommentRightsController::class, $this->subject);
    }
    ...
    {
        $class = new ReflectionClass(CommentRightsController::class);
