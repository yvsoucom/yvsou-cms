...
final class FileLibraryControllerTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(FileLibraryController::class, $this->subject);
    }
    ...
    {
        $class = new ReflectionClass(FileLibraryController::class);
