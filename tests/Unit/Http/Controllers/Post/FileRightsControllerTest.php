...
final class FileRightsControllerTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(FileRightsController::class, $this->subject);
    }
    ...
    {
        $class = new ReflectionClass(FileRightsController::class);
