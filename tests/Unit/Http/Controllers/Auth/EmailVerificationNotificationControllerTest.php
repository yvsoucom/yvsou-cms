...
final class EmailVerificationNotificationControllerTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(EmailVerificationNotificationController::class, $this->subject);
    }
    ...
    {
        $class = new ReflectionClass(EmailVerificationNotificationController::class);
