...
final class DomainViewControllerTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(DomainViewController::class, $this->subject);
    }
    ...
    {
        $class = new ReflectionClass(DomainViewController::class);
