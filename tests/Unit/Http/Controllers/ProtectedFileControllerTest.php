...
final class ProtectedFileControllerTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(ProtectedFileController::class, $this->subject);
    }
    ...
    {
        $class = new ReflectionClass(ProtectedFileController::class);
