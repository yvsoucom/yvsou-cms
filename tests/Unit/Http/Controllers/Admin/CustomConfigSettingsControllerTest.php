...
final class CustomConfigSettingsControllerTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(CustomConfigSettingsController::class, $this->subject);
    }
    ...
    {
        $class = new ReflectionClass(CustomConfigSettingsController::class);
