...
final class CastMsgControllerTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(CastMsgController::class, $this->subject);
    }
    ...
    {
        $class = new ReflectionClass(CastMsgController::class);
