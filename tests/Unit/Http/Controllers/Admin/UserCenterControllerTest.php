...
final class UserCenterControllerTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(UserCenterController::class, $this->subject);
    }
    ...
    {
        $class = new ReflectionClass(UserCenterController::class);
