...
final class ExternalApiControllerTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(ExternalApiController::class, $this->subject);
    }
    ...
    {
        $class = new ReflectionClass(ExternalApiController::class);
