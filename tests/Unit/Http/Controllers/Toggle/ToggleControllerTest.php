...
final class ToggleControllerTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(ToggleController::class, $this->subject);
    }
    ...
    {
        $class = new ReflectionClass(ToggleController::class);
