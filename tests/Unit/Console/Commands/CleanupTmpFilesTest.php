...
final class CleanupTmpFilesTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(CleanupTmpFiles::class, $this->subject);
    }
    ...
    {
        $class = new ReflectionClass(CleanupTmpFiles::class);
