...
final class WebSocketCommandTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(WebSocketCommand::class, $this->subject);
    }
    ...
    {
        $class = new ReflectionClass(WebSocketCommand::class);
