...
final class PostReversionDiffTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(PostReversionDiff::class, $this->subject);
    }
    ...
    {
        $class = new ReflectionClass(PostReversionDiff::class);
