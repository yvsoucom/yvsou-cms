...
use App\Livewire\ShowDomainTree;
...
final class ShowDomainTreeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(ShowDomainTree::class, $this->subject);
    }
    ...
    {
        $class = new ReflectionClass(ShowDomainTree::class);
