...
final class DomainSearchKeyTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(DomainSearchKey::class, $this->subject);
    }
    ...
    {
        $class = new ReflectionClass(DomainSearchKey::class);
