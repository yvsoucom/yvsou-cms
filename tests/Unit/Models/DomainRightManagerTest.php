...
final class DomainRightManagerTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(DomainRightManager::class, $this->subject);
    }
    ...
    {
        $class = new ReflectionClass(DomainRightManager::class);
