...
final class DscloudMsgModelTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(DscloudMsgModel::class, $this->subject);
    }
    ...
    {
        $class = new ReflectionClass(DscloudMsgModel::class);
