...
final class DomainUserSearchKeyTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(DomainUserSearchKey::class, $this->subject);
    }
    ...
    {
        $class = new ReflectionClass(DomainUserSearchKey::class);
