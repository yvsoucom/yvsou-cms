...
final class DomainUnreadSubTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(DomainUnreadSub::class, $this->subject);
    }
    ...
    {
        $class = new ReflectionClass(DomainUnreadSub::class);
