...
final class DomainMsgTemplateTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(DomainMsgTemplate::class, $this->subject);
    }
    ...
    {
        $class = new ReflectionClass(DomainMsgTemplate::class);
