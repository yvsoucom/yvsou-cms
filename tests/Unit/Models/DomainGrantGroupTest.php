...
final class DomainGrantGroupTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(DomainGrantGroup::class, $this->subject);
    }
    ...
    {
        $class = new ReflectionClass(DomainGrantGroup::class);
