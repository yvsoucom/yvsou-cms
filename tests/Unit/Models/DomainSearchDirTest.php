...
final class DomainSearchDirTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(DomainSearchDir::class, $this->subject);
    }
    ...
    {
        $class = new ReflectionClass(DomainSearchDir::class);
