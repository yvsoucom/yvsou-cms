...
final class ProcessInviteFriendTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(ProcessInviteFriend::class, $this->subject);
    }
    ...
    {
        $class = new ReflectionClass(ProcessInviteFriend::class);
