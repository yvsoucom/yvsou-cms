...
final class DomainUploadAttachTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(DomainUploadAttach::class, $this->subject);
    }
    ...
    {
        $class = new ReflectionClass(DomainUploadAttach::class);
