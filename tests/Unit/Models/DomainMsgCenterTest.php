...
final class DomainMsgCenterTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(DomainMsgCenter::class, $this->subject);
    }
    ...
    {
        $class = new ReflectionClass(DomainMsgCenter::class);
