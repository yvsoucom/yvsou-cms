...
final class DomainGrantUserTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(DomainGrantUser::class, $this->subject);
    }
    ...
    {
        $class = new ReflectionClass(DomainGrantUser::class);
