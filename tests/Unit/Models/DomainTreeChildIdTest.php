...
final class DomainTreeChildIdTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(DomainTreeChildId::class, $this->subject);
    }
    ...
    {
        $class = new ReflectionClass(DomainTreeChildId::class);
