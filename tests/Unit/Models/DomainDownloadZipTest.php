...
final class DomainDownloadZipTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(DomainDownloadZip::class, $this->subject);
    }
    ...
    {
        $class = new ReflectionClass(DomainDownloadZip::class);
