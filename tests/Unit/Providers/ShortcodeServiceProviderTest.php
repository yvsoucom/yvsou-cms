...
final class ShortcodeServiceProviderTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(ShortcodeServiceProvider::class, $this->subject);
    }
    ...
    {
        $class = new ReflectionClass(ShortcodeServiceProvider::class);
