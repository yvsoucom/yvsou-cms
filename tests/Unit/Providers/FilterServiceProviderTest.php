...
final class FilterServiceProviderTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(FilterServiceProvider::class, $this->subject);
    }
    ...
    {
        $class = new ReflectionClass(FilterServiceProvider::class);
