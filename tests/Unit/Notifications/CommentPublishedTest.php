...
final class CommentPublishedTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(CommentPublished::class, $this->subject);
    }
    ...
    {
        $class = new ReflectionClass(CommentPublished::class);
