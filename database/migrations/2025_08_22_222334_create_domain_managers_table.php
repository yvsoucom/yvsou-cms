    ...
    public function up(): void
    {
        if (!Schema::hasTable('domain_managers')) {
            Schema::create('domain_managers', function (Blueprint $table) {
                ...
                $table->string('IP', 45)->default('0.0.0.0'); // IPv6 safe
                $table->dateTime('cDate')->index();
