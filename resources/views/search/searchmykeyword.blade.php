...
@section('content')
    <div class="space-y-4">
        <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-3">Found my articles</h2>
        ...
        <div
            ...
            <ul class="space-y-3">
                ...
                @foreach ($postlines as $item)
                    <li class="hover:bg-gray-50 dark:hover:bg-gray-700/40 px-2 py-1 rounded transition-colors">
                        <a href="{{ $item['url'] }}"
